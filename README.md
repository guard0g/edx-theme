Overview
========
This directory stores the Overbrook School theme for an Open edX instance.
...
![Alt text](/static/images/sunrise.jpg?raw=true "OverbrookX Default Theme Screenshot")
